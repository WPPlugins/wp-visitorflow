...
?>
	...
	<tr>
		<th class="wpvftable-title" colspan="2"><?php echo sprintf(__('Summary for Page "%s"', 'wp_visitorflow'), $selected_title); ?></th>
	</tr>	
	<tr>
		<td class="right"><?php echo  __('Incoming page hits', 'wp_visitorflow'); ?>:</td>
		<td><?php echo  $flow_data[-1]['total_flow_sum']; ?></td>
	</tr>
	<tr>
		<td class="right"><?php echo  __('Outgoing page hits', 'wp_visitorflow'); ?>:</td>
		<td><?php echo  $flow_data[+1]['total_flow_sum']; ?></td>
	</tr>
	<tr>
		<td class="right"><?php echo  __('Page views per day', 'wp_visitorflow'); ?>:</td>
		<td><?php echo  sprintf("%3.1f", $flow_data[-1]['total_flow_sum'] * $db_info['perdayfactor']); ?></td>
	</tr>
	<tr>
		<td class="right"><?php echo  __('Page View Duration', 'wp_visitorflow'); ?>:</td>
		<td><?php echo  $flow_data[+1]['staytime_mean'] . ' ± '. $flow_data[+1]['staytime_sigma'] . ' sec'; ?></td>
	</tr>
	<tr>
		<td class="right"><?php echo  __('Exit rate', 'wp_visitorflow'); ?>:</td>
